...
<?php } ?>
<div class="BlogMainWrapper BlogItemsByTags">
	<div class="mainBlogBoxItems">
		<div class="blogMainGridWrapper">
			...
			<div class="loadmoreWrapper">
				<a href="javascript:void(0);" id="seeMoreByTags" class="hover-effect-right" data-next="2" data-id="<?php echo $tagid; ?>"><span class="icon-chevron-right"></span><?php echo JText::_('COM_BLOGSTERS_SHOW_MORE'); ?></a>
			</div>
