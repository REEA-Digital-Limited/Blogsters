...
namespace Joomla\Component\Blogsters\Administrator\Service\HTML;
...
class AdministratorService
{
	...
	public function association($articleid)
	{
		...
		if ($associations = Associations::getAssociations('com_blogsters', '#__blogsters', 'com_blogsters.item', $articleid))
		{
