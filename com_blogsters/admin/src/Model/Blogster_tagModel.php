...
class Blogster_tagModel extends AdminModel
{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_blogsters.blogster_tag', 'blogster_tag', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_blogsters.edit.blogster_tag.data', array());
		...
		$this->preprocessData('com_blogsters.blogster_tag', $data);
