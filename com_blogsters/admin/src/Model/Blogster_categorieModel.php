...
class Blogster_categorieModel extends AdminModel
{
	...
	public function publish(&$pks, $value = 1) {
		...
		$query->update('`#__blogsters_categories`');
	...
	{
		// Get the form.
		$form = $this->loadForm('com_blogsters.blogster_categorie', 'blogster_categorie', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = $app->getUserState('com_blogsters.edit.blogster_categorie.data', array());
		...
		$this->preprocessData('com_blogsters.blogster_categorie', $data);
