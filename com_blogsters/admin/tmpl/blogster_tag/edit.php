...
<form action="<?php echo Route::_('index.php?option=com_blogsters&view=blogster_tag&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="blogster-tag-form" class="form-validate">
