...
<form action="<?php echo Route::_('index.php?option=com_blogsters&view=blogster_author&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="blogster-tag-form" class="form-validate">
	...
	<div>
		...
		<div class="row">
			<div class="col-md-9">
				<div class="row">
					<div class="col-md-12">
						<?php echo $this->form->renderField('author_bio'); ?>
					</div>
				</div>
			</div>
			<div class="col-md-3">
